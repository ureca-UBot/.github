...
- 8. LLM 모델 평가 지표를 확정하기 어려웠습니다. 한국어를 지원하는 모듈도 많지 않았고 정확도가 다소 떨어진다고 판단했습니다. LLM이나 인간이 JUDGE 하지 않고, 한국어 능력이나 정보의 정확도를 정확하게 따질 수 있는 테스트 기준을 찾기 어려웠습니다. 실무에서는 LLM 성능을 어떻게 평가하는지 궁금합니다.
