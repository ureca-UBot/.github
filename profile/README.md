...
- 2. 실제 AI 상담 서비스를 운영할 때, 사용자의 질문이 서비스 도메인과 관련 있는지 없는지가 명확하지 않은 경우가 많을 것 같습니다. 이런 경우 현업에서는 LLM이 어느 정도까지 답변하도록 허용하는지 궁금합니다. - 경계를 어떻게 정하냐? 란 뉘앙스를 풍기도록 질문 / 도메인으로 제한하지 말고 일반적인 상황으로 질문
